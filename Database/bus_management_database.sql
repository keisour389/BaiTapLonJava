...
INSERT INTO `account_info` VALUES ('1','1',1,1,NULL,NULL,NULL),('2','2',2,2,NULL,NULL,NULL),('5','5',5,5,NULL,NULL,NULL),('6','6',6,6,NULL,NULL,NULL),('7','7',7,7,NULL,NULL,NULL),('8','8',8,8,NULL,NULL,NULL),('testy','testy',0,0,'2021-03-30 16:30:54','2021-03-30 16:30:54',NULL),('testyy','$2a$10$.ncUyYh5LYyZGzjUWm/Zw.1fCOm5ZzohteiKJIRdFxM3kl1yWmcyK',0,0,'2021-03-30 16:34:21','2021-03-30 16:34:21',NULL),('testyyy','$2a$10$IUoXhS9GURK5/8hiDgOvQOLAI7sLALB7EBMA4A//65AOQyKF5K6uK',0,0,'2021-03-30 17:06:23','2021-03-30 17:06:23',NULL),('testyyyy','$2a$10$iffqlM1zLuEuDwiIymVCeekNaxT5aLHZ21KbNZzncWsTzCH/GuK36',0,0,'2021-03-30 17:19:32','2021-03-30 17:19:32',NULL),('testyyyyy','$2a$10$6xDtT2As/b0sB6iootXyUu6knitTAP/oj.AlUyG3XBx9wszJy47W6',0,0,'2021-03-30 17:20:24','2021-03-30 17:20:24',NULL);
...
CREATE TABLE `bus_schedules` (
  `TRIP_ID` varchar(20) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `LICENSE_PLATES` varchar(20) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `MAIN_DRIVER` varchar(20) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `SUB_DRIVER` varchar(20) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `FROM` varchar(100) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `TO` varchar(100) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `DEPARTURE_DAY` datetime NOT NULL,
  `TOTAL_TIME` int NOT NULL,
  `STATUS` int NOT NULL,
  `VEHICLE_TYPE` varchar(100) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `TOTAL_SEATS` int NOT NULL,
  `CREATED_ON` datetime DEFAULT NULL,
  `UPDATED_ON` datetime DEFAULT NULL,
  `NOTE` varchar(200) COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `MANAGER` varchar(20) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  PRIMARY KEY (`TRIP_ID`),
...
CREATE TABLE `cancel_history` (
  `CANCEL_ID` varchar(20) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `REASON` varchar(100) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `NOTE` varchar(200) COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `CUS_ID` varchar(20) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `EMP_ID` varchar(20) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `TICKET_ID` varchar(20) COLLATE utf8mb4_unicode_520_ci NOT NULL,
...
CREATE TABLE `cus_info` (
  ...
  CONSTRAINT `fk_cus_info_account_info1` FOREIGN KEY (`USER_ID`) REFERENCES `account_info` (`USER_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `emp_info` (
  ...
  `LAST_NAME` varchar(100) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `DISPLAY_NAME` varchar(200) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `PHONE_NUMBER` varchar(100) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `DOB` datetime NOT NULL,
  `ADDRESS` varchar(200) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `ID` varchar(30) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `GENDER` varchar(50) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `TYPE` int NOT NULL,
  `CREATED_ON` datetime DEFAULT NULL,
  `UPDATED_ON` datetime DEFAULT NULL,
  `NOTE` varchar(200) COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  PRIMARY KEY (`USER_ID`),
  CONSTRAINT `fk_emp_info_account_info` FOREIGN KEY (`USER_ID`) REFERENCES `account_info` (`USER_ID`)
...
CREATE TABLE `feedback` (
  `FEEDBACK_ID` varchar(20) COLLATE utf8mb4_unicode_520_ci NOT NULL,
...
CREATE TABLE `ticket_management` (
  `TICKET_ID` varchar(20) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `SEAT_ID` varchar(30) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  ...
  `NOTE` varchar(200) COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `TRIP_ID` varchar(20) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `CUS_ID` varchar(20) COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
...
-- Dump completed on 2021-03-31 15:35:05
